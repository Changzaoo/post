// Vercel Serverless Function - Publish to Discord
// Uses DISCORD_WEBHOOK_URL from backend environment variables
  ...
  try {
    ...
    if (!webhookUrl) {
      return res.status(500).json({
        status: 'error',
        message: 'Discord não configurado. Defina DISCORD_WEBHOOK_URL nas variáveis de ambiente do servidor.',
      });
    }
